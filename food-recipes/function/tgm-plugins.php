...
add_action( 'foodrecipes_register', 'foodrecipes_theme_register_plugins' );
/* Register the required plugins for this theme. */
function foodrecipes_theme_register_plugins() {
 /*Array of plugin arrays. Required keys are name and slug. */
    ...
    $config = array(
        'id'           => 'foodrecipes',                 // Unique ID for hashing notices for multiple instances of TGMPA.
        'default_path' => '',                      // Default absolute path to pre-packaged plugins.
        'menu'         => 'foodrecipes-install-plugins', // Menu slug.
